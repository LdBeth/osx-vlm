...
Run the QLD guest as before (`fresh.ilod`, `GENERA_SYS_ROOT` /
`-minifsroot` for the C MINI inner-system load) **plus**
`MINI_COEXIST=1` in the environment.  With coexist on, the in-emulator
