...
g6530:
  ...
  asm goto ("0:\tldrb %w[val], [%[adr]]\n\t"
    ...
    ".quad 0b, %l[decodefault]\n\t"
    ".popsection"
    : [val] "=r"(t2) : [adr] "r"(t8) : "memory" : decodefault);
  /* Stack cache offset */
  t4 = t1 - t4;
  arg1 = cached_datawrite_mask;
  /* In range? */
...
g6542:
  asm goto ("0:\tstr %w[val], [%[adr]]\n\t"
    ...
    ".popsection"
    : : [val] "r"(t6), [adr] "r"(t3), [tag] "r"(t2), [tadr] "r"(t4)
    : "memory" : decodefault);
  /* J. if in cache */
  if ((arg1 != 0))
    goto g6541;
...
g6543:
  ...
  asm goto ("0:\tldrb %w[val], [%[adr]]\n\t"
    ...
    ".quad 0b, %l[decodefault]\n\t"
    ".popsection"
    : [val] "=r"(arg3) : [adr] "r"(t4) : "memory" : decodefault);
  /* Stack cache offset */
  t2 = t1 - t2;
...
g6558:
  asm goto ("0:\tstr %w[val], [%[adr]]\n\t"
    ...
    ".quad 1b, %l[decodefault]\n\t"
    ".popsection"
    : : [val] "r"(t6), [adr] "r"(t7), [tag] "r"(arg3), [tadr] "r"(t2)
    : "memory" : decodefault);
  /* J. if in cache */
  if ((t8 != 0))
    goto g6557;
...
g6593:
  asm goto ("0:\tstr %w[val], [%[adr]]\n\t"
    ...
    ".quad 1b, %l[decodefault]\n\t"
    ".popsection"
    : : [val] "r"(arg1), [adr] "r"(arg6), [tag] "r"(arg5), [tadr] "r"(t5)
    : "memory" : decodefault);
  /* J. if in cache */
  if ((t8 != 0))
    goto g6592;
