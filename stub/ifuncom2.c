...
g6530:
  ...
  asm goto ("0:\tldr %[val], [%[adr]]\n\t"
    ...
    ".quad 0b, %l[decodefault]\n\t"
    ".popsection"
    : [val] "=r"(t2) : [adr] "r"(t8 & ~7L) : "memory" : decodefault);
  /* Stack cache offset */
  t4 = t1 - t4;
...
g6540:
  ...
  asm goto ("0:\tldr %[val], [%[adr]]\n\t"
    ...
    ".quad 0b, %l[decodefault]\n\t"
    ".popsection"
    : [val] "=r"(t8) : [adr] "r"(t4 & ~7L) : "memory" : decodefault);
  /* Stack cache offset */
  t7 = t1 - t7;
  /* In range? */
...
g6542:
  ...
  asm goto ("0:\tstr %w[val], [%[adr]]\n\t"
    ...
    ".quad 0b, %l[decodefault]\n\t"
    ".popsection"
    : : [val] "r"(t6), [adr] "r"(t3) : "memory" : decodefault);
...
g6543:
  ...
  asm goto ("0:\tldr %[val], [%[adr]]\n\t"
    ...
    ".quad 0b, %l[decodefault]\n\t"
    ".popsection"
    : [val] "=r"(arg3) : [adr] "r"(t4 & ~7L) : "memory" : decodefault);
  /* Stack cache offset */
  t2 = t1 - t2;
...
g6558:
  ...
  asm goto ("0:\tstr %w[val], [%[adr]]\n\t"
    ...
    ".quad 0b, %l[decodefault]\n\t"
    ".popsection"
    : : [val] "r"(t6), [adr] "r"(t7) : "memory" : decodefault);
  asm goto ("0:\tstr %[val], [%[adr]]\n\t"
    ".pushsection __DATA,__vm_extable\n\t"
    ".p2align 3\n\t"
    ".quad 0b, %l[decodefault]\n\t"
...
g6591:
  ...
  asm goto ("0:\tldr %[val], [%[adr]]\n\t"
    ...
    ".quad 0b, %l[decodefault]\n\t"
    ".popsection"
    : [val] "=r"(t7) : [adr] "r"(t5 & ~7L) : "memory" : decodefault);
  /* Stack cache offset */
  t6 = arg2 - t11;
  /* In range? */
...
g6593:
  ...
  asm goto ("0:\tstr %w[val], [%[adr]]\n\t"
    ...
    ".quad 0b, %l[decodefault]\n\t"
    ".popsection"
    : : [val] "r"(arg1), [adr] "r"(arg6) : "memory" : decodefault);
  asm goto ("0:\tstr %[val], [%[adr]]\n\t"
    ".pushsection __DATA,__vm_extable\n\t"
    ".p2align 3\n\t"
    ".quad 0b, %l[decodefault]\n\t"
