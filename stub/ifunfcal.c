...
g6807:
  ...
  asm goto ("0:\tldrb %w[val], [%[adr]]\n\t"
    ...
    ".quad 0b, %l[decodefault]\n\t"
    ".popsection"
    : [val] "=r"(arg5) : [adr] "r"(t5) : "memory" : decodefault);
  /* Stack cache offset */
  t3 = t2 - t11;
  t6 = cached_dataread_mask;
  /* In range? */
...
g6883:
  ...
  asm goto ("0:\tldrb %w[val], [%[adr]]\n\t"
    ...
    ".quad 0b, %l[decodefault]\n\t"
    ".popsection"
    : [val] "=r"(t8) : [adr] "r"(t12) : "memory" : decodefault);
  /* Stack cache offset */
  t10 = t2 - t10;
  /* In range? */
...
g6895:
  ...
  asm goto ("0:\tstr %w[val], [%[adr]]\n\t"
    ...
    ".popsection"
    : : [val] "r"(t6), [adr] "r"(t9), [tag] "r"(t8), [tadr] "r"(t10)
    : "memory" : decodefault);
...
g6917:
  ...
  asm goto ("0:\tldrb %w[val], [%[adr]]\n\t"
    ...
    ".quad 0b, %l[decodefault]\n\t"
    ".popsection"
    : [val] "=r"(t7) : [adr] "r"(arg1) : "memory" : decodefault);
  /* Stack cache offset */
  t8 = t1 - t8;
  arg2 = cached_bindread_mask;
  /* In range? */
  t9 = ((u64)t8 < (u64)t9) ? 1 : 0;
  asm goto ("0:\tldrsw %[val], [%[adr]]\n\t"
    ".pushsection __DATA,__vm_extable\n\t"
...
g6927:
  ...
  asm goto ("0:\tldrb %w[val], [%[adr]]\n\t"
    ...
    ".quad 0b, %l[decodefault]\n\t"
    ".popsection"
    : [val] "=r"(t3) : [adr] "r"(arg1) : "memory" : decodefault);
  /* Stack cache offset */
  t8 = t5 - t8;
  arg2 = cached_bindread_mask;
  /* In range? */
...
g6949:
  ...
  asm goto ("0:\tstr %w[val], [%[adr]]\n\t"
    ...
    ".quad 1b, %l[decodefault]\n\t"
    ".popsection"
    : : [val] "r"(t6), [adr] "r"(t9), [tag] "r"(t8), [tadr] "r"(arg1)
    : "memory" : decodefault);
